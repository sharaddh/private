  ...
  return (
    <div className="max-w-lg mx-auto space-y-6 animate-fade-in">
      <div>
        <button
          onClick={() => navigate(-1)}
          className="flex items-center gap-1.5 text-caption text-th-secondary hover:text-th-text mb-4 transition-colors"
        >
      ...
      <div className="glass-card p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {isLoading ? (
              <>
                <Spinner size={14} className="border-surface-950 border-t-transparent" />{' '}
                Creating...
              </>
            ) : (
              <>
