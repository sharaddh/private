...
export const createVariantWithStockSchema = z.object({
...
export const withdrawStockSchema = z.object({
  items: z
    .array(
      z.object({
...
export const stockAdjustSchema = z.object({
  quantity: z.number().int().min(-100000).max(100000).refine((v) => v !== 0, "Adjustment quantity must be non-zero"),
  note: z.string().optional(),
}).strict();
