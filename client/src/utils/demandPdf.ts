...
function lensTypeLabel(lensType: string): string {
  if (lensType === "sph") return "SPH";
  if (lensType === "cyl") return "CYL";
...
export function generateDemandPdf(data: DemandPdfData): void {
  ...
  doc.text("Generated by KMJ Optical", pageWidth / 2, footerY + 6, { align: "center" });
