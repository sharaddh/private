    ...
    if (this.state.hasError) {
      ...
      return (
        ...
        >
          ...
          <p className="text-[16px] text-th-secondary mb-2 max-w-md">
            {this.state.error?.message || "An unexpected error occurred"}
          </p>
          {import.meta.env.DEV && this.state.error?.stack && (
            <pre className="text-[12px] text-th-secondary/60 max-w-lg mb-6 overflow-auto text-left whitespace-pre-wrap bg-th-hover/50 p-3 rounded-lg">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 bg-th-hover hover:bg-th-active text-th-text font-semibold px-6 py-2.5 rounded-lg uppercase tracking-wider text-[14px] transition-all duration-200 active:scale-[0.95]"
            >
