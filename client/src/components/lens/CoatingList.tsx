...
export default function CoatingList({ items, selectedId, scope, onSelect, onAdd, onDelete, onRename }: Props) {
              ...
              {isEditing ? (
                ...
                <>
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-small mt-0.5 font-bold text-th-muted">−₹{item.priceNeg ?? 0} / +₹{item.pricePos ?? 0}</div>
                  </div>
