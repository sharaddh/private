...
export default function Toast({ message, type, onClose, duration = 4000 }: ToastProps) {
  ...
  return (
    <div
      className={`fixed bottom-20 right-4 sm:bottom-5 sm:right-5 z-[100] flex items-center gap-3 px-4 py-3 rounded-[8px] text-[18px] font-medium animate-slide-up max-sm:max-w-[calc(100vw-2rem)] ${styles[type]}`}
