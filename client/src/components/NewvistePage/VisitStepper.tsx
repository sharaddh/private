...
export default function VisitStepper({ steps, currentIdx, setStep }: Props) {
  return (
    <div className="mb-6">
            ...
            return (
              ...
              >
                ...
                <motion.button
                  ...
                  onClick={() => {
                    if (completed || active) setStep(step.key);
                  }}
                ...
                >
                  ...
                  <motion.span
                    ...
                    ${
                      completed ? 'text-[#1ed760]' : active ? 'text-[#1ed760]' : 'text-th-secondary'
                    }
                  `}
                  >
                    {step.label}
