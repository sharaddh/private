    ...
    <div className="flex items-center gap-1.5 flex-wrap">
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          className="w-7 h-7 rounded-[9999px] flex items-center justify-center text-th-secondary hover:text-th-text hover:bg-th-elevated transition-all duration-200 bg-th-elevated"
        >
          <ChevronLeft size={14} />
        </button>
        <input
