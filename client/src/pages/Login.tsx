    ...
    <div className="min-h-screen bg-th-base flex items-center justify-center p-4" style={{ fontFamily: "Inter, system-ui, sans-serif" }}>
      <div className="w-full max-w-sm animate-fade-in">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-th-secondary mt-1 font-normal">{uiT("Admin Login")}</p>
        </div>
        ...
        <div className="bg-th-surface rounded-lg p-6 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-th-secondary mb-1.5">{uiT("Branch")}</label>
          ...
          <p className="text-center text-sm text-th-secondary mt-5">
            {uiT("Staff?")} <Link to="/staff-login" className="text-[#1ed760] hover:underline font-medium">{uiT("Login here")}</Link>
          </p>
        </div>
      </div>
    </div>
