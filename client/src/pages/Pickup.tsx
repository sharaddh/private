  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Search customer, collect payment, and mark order as delivered.</p>
      </div>
        ...
        <div className="card">
          ...
          {orders.length > 0 && !selectedOrder && (
            <div className="space-y-2">
              <p className="text-sm font-medium text-gray-500">{orders.length} pending order(s)</p>
              {orders.map((o: any) => (
