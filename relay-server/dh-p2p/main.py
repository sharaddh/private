...
def main(serial, dtype=0, username=None, password=None, debug=False, port=554):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--port", type=int, default=554, help="Local RTSP port to listen on")
